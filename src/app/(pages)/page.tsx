        ...
        <div className="scrollbar w-full overflow-hidden relative">
            ...
            <section className="text-gray-800 md:w-5/6 h-fit mx-auto z-50">
                ...
                <div className="items-center grid grid-col-1 md:grid-cols-3 mx-auto py-36">
                    <div className="flex  px-3 flex-col col-span-2 justify-center text-center rounded-sm  lg:text-left">
                        <FadeInOnScroll direction="bottom" duration={0.2}>
                ...
                <div className="flex gap-5 md:gap-8 justify-center items-center  md:w-4/5 mx-auto flex-wrap">
                    {
                        skills.map((skill, index) => (
                            <Image key={index} src={skill.src} alt={skill.alt} className={skill.size || "h-8 w-8 md:h-14 md:w-14"} />
                        ))
                    }
                </div>
            </div>
            ...
            <div className="flex flex-col gap-8" >
                <div className="flex flex-col justify-center items-center">
                    <h2 className="relative text-4xl font-bold mb-2 w-full text-center text-white tracking-[8px]">
                        <FadeInOnScroll direction="bottom" duration={0.4}>
                            Education
                        </FadeInOnScroll>
                        <FadeInOnScroll direction="bottom" duration={0.6} className="absolute -top-6 -left-3 inset-0 -z-10">
                            <span className=" w-full text-center text-gray-200 text-[5rem] font-bold tracking-[10px] leading-none opacity-10">
                                Education
                            </span>
                        </FadeInOnScroll>
                    </h2>
            ...
            <div className="flex flex-col pt-24 items-center gap-4" >
                ...
                <ul className="flex text-violet-600 mb-4 ">
                    <li className="border border-r-0 px-2 py-1 rounded-s-full text-xs md:text-md">All</li>
                    <li className="border border-r-0 px-2 py-1 text-sm md:text-md">Landing Page</li>
                    <li className="border border-r-0 px-2 py-1 text-xs md:text-md">Web Apps</li>
                    <li className="border px-2 py-1 rounded-e-full text-xs md:text-md">Mobile Apps</li>
                </ul>
                <div className="overflow-hidden grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-5 md:px-10 gap-3 align-content-center">
                    {
                        projects.map((project, index) => (
                            <FadeInOnScroll key={index} direction="left" duration={0.3} className="flex items-stretch">
            ...
            <div className="flex flex-col gap-2 mx-3 md:mx-10" >
                <FadeInOnScroll direction="bottom" duration={0.4} className="w-full">
